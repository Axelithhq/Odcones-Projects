      ...
      <section className="py-20 bg-theme-base">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="p-8 rounded-3xl bg-forest-900/40 border border-forest-800 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-theme-text-muted leading-relaxed">{t("terms.para1")}</p>
            <p className="text-xs sm:text-sm text-theme-text-muted leading-relaxed">{t("terms.para2")}</p>
            <p className="text-xs sm:text-sm text-theme-text-muted leading-relaxed">{t("terms.para3")}</p>
          </div>
          <p className="text-xs text-theme-text-muted">{t("terms.contactUs")}</p>
        </div>
      </section>
